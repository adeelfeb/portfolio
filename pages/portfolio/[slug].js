...
export default function PortfolioDetailPage() {
  ...
  const structuredData = portfolio ? {
    ...
    mainEntityOfPage: {
      '@type': 'WebPage',
      '@id': `https://designndev.com/portfolio/${portfolio.slug}`,
    },
          ...
          <main className="pt-24 pb-16">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className={styles.portfolioError}>
                ...
                <Link href="/portfolio" className={styles.portfolioDetailBackLink}>
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://designndev.com/portfolio/${portfolio.slug}`} />
        ...
        <main className="pt-24 pb-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav className={styles.portfolioDetailBreadcrumb} aria-label="Breadcrumb">
              <Link href="/portfolio" className={styles.portfolioDetailBreadcrumbLink}>
                Portfolio
              </Link>
