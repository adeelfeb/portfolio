  ...
  const goals = [
    {
      ...
      description: 'Empowering communities to maintain cleaner, healthier urban environments.',
    },
    {
      icon: (
        <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      description: 'Real-time analytics help authorities allocate resources where they are needed most.',
    },
    {
      icon: (
        <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      description: 'Building a network of active citizens working together for environmental change.',
    },
  ]
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-gray-600 text-lg font-subheading mb-8 leading-relaxed">
              We aim to transform how communities interact with their environment through technology and collaboration.
            </p>
            ...
            <div className="aspect-square bg-gradient-to-br from-teal-100 to-teal-50 rounded-3xl overflow-hidden">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="font-subheading text-teal-700 font-semibold text-lg">Global Impact</p>
                </div>
              </div>
            </div>
          </motion.div>
