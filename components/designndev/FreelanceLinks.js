...
const freelanceLinks = [
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
        <path d="M17.4 7.5h-3v9h3v-9zm-6.7 0h-3v2.3h1.6c.4 0 .8.1 1.1.4.3.3.4.6.4 1.1v5.2h3v-6.1c0-1.6-1.3-2.9-2.9-2.9h-.2zm-5 0H3v9h2.7v-3.2h1.2c.4 0 .8-.1 1.1-.4.3-.3.4-.6.4-1.1V9.9c0-1.3-1.1-2.4-2.4-2.4H5.7zM12 6c.8 0 1.4-.6 1.4-1.4S12.8 3.2 12 3.2s-1.4.6-1.4 1.4S11.2 6 12 6z"/>
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
        <path d="M17.6 6.5c-1.1 0-2 .9-2 2v6c0 1.1.9 2 2 2s2-.9 2-2v-6c0-1.1-.9-2-2-2zM7.5 9.5c-2.2 0-4 1.8-4 4s1.8 4 4 4c1.3 0 2.5-.6 3.3-1.6l-1.4-1.4c-.4.5-1 .8-1.8.8-1.4 0-2.5-1.1-2.5-2.5s1.1-2.5 2.5-2.5c.8 0 1.4.3 1.8.8l1.4-1.4c-.8-1-2-1.6-3.3-1.6z"/>
      </svg>
    ),
