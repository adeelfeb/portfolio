...
const reviews = [
  {
    ...
    rating: 5,
    timeAgo: '1 month ago',
    review: `Its amazing doing work again with Adeel. His level of understanding the task is outstanding. Will recommend him for any game related work you need.`,
  },
  {
    id: 2,
    name: 'Uday Prudhvi',
    ...
    rating: 5,
    timeAgo: '1 month ago',
    review: `We hired Adeel specifically for third-party API integrations and webhook automation — and he nailed every connection end to end. GoHighLevel (GHL): Deal-created webhooks, agreement-sent workflow, customer call ingestion, and inbound callbacks to update pipeline stages. The full lead → agreement → signed flow is bulletproof.`,
  },
  {
    id: 3,
    name: 'Uday Prudhvi',
    ...
    rating: 5,
    timeAgo: '1 month ago',
    review: `Adeel delivered a complete full-stack web application for our funding intelligence and operations platform — built on Next.js, MongoDB, and a secure role-based dashboard. He did not just wire up APIs; he built a production-ready system we use daily. The Deal Management module is robust and intuitive.`,
  },
  {
    id: 4,
    name: 'Smith Patvekar',
    ...
    rating: 5,
    timeAgo: '1 month ago',
    review: `Adeel is such an expert in creating websites which are fast. He is so helpful and will get the job done for you in no time. Very prompt with his responses. If you want to really get your job done and want someone to rely on, he is the man.`,
  },
  {
    id: 5,
    name: 'Tobey Sicard',
