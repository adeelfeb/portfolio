...
export const env = {
  ...
  MONGODB_URI: getEnvVar('MONGODB_URI', isDev ? 'mongodb://127.0.0.1:27017/proofresponse' : ''),
  
  // Authentication
  JWT_SECRET: getEnvVar('JWT_SECRET', isDev ? 'dev-jwt-secret-change-me' : ''),
  ...
  // SMTP configuration (for SMTP protocol)
